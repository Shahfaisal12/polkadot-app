    ...
    return (
        <div className="any-typ-block bg-172026">
            ...
            <div className="row pt-0">
                <div className="col-md-8 col-12 overflow-hidden d-flex justify-content-center align-item-center">
                ...
                <div className="col-md-4 px-2 pt-4 p-sm-4">
                    <div className="py-md-4 text-white" >
                        <h2 className="text-white fw-bold">Any type of data across any type of blockchain</h2>
