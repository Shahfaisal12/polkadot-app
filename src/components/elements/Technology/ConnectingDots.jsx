...
const ConnectingDots = () => {
  ...
  <div className="container  py-0 py-md-5">
    ...
    <div className="row justify-content-start mb-5">
      <div className="col-12 col-md-6 col-lg-3 mb-3">
        <div className="card h-100 border-0">
          <img className="card-img mb-3" src="https://polkadot.network/assets/img/icons/glossary/icon-glossary-relay-chain.svg?v=ea608e625d" alt=''/>
      ...
      <div className="col-12 col-md-6 col-lg-3 mb-3">
        <div className="card h-100 border-0">
          <img className="card-img mb-3" src="https://polkadot.network/assets/img/icons/glossary/icon-glossary-parachain.svg?v=ea608e625d" alt=''/>
      ...
      <div className="col-12 col-md-6 col-lg-3 mb-3">
        <div className="card h-100 border-0">
          <img className="card-img mb-3" src="https://polkadot.network/assets/img/icons/glossary/icon-glossary-parathread.svg?v=ea608e625d" alt=''/>
      ...
      <div className="col-12 col-md-6 col-lg-3 mb-3">
        <div className="card h-100 border-0">
          <img className="card-img mb-3" src="https://polkadot.network/assets/img/icons/glossary/icon-glossary-bridge.svg?v=ea608e625d" alt=''/>
    ...
    <div className="row justify-content-start mb-5 align-content-md-stretch">
      <div className="col-12 col-md-6 col-lg-3 mb-3">
        <div className="card h-100 border-0">
          <img className="card-img mb-3" src="https://polkadot.network/assets/img/icons/glossary/icon-glossary-nominator.svg?v=ea608e625d" alt='' />
      ...
      <div className="col-12 col-md-6 col-lg-3 mb-3">
        <div className="card h-100 border-0">
          <img className="card-img mb-3" src="https://polkadot.network/assets/img/icons/glossary/icon-glossary-validator.svg?v=ea608e625d" alt='' />
      ...
      <div className="col-12 col-md-6 col-lg-3 mb-3">
        <div className="card h-100 border-0">
          <img className="card-img mb-3" src="https://polkadot.network/assets/img/icons/glossary/icon-glossary-collator.svg?v=ea608e625d" alt=''/>
    ...
    <div className="row justify-content-start align-content-md-stretch">
      <div className="col-12 col-md-6 col-lg-3 mb-3">
        <div className="card h-100 border-0">
          <img className="card-img mb-3" src="https://polkadot.network/assets/img/icons/glossary/icon-glossary-council-member-2.svg?v=ea608e625d"alt=''/>
      ...
      <div className="col-12 col-md-6 col-lg-3 mb-3">
        <div className="card h-100 border-0">
          <img className="card-img mb-3" src="https://polkadot.network/assets/img/icons/glossary/icon-glossary-technical-committee-2.svg?v=ea608e625d" alt=''/>
