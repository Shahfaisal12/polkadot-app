                                        ...
                                        <div className="card-body py-2">
                                            <div className="d-flex align-items-center">
                                                ...
                                                <div className='mx-2'>
                                                    ...
                                                    <p className="mb-0">Follow @Polkadot.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="card shadow-lg bg-white rounded-lg">
                                        <div className="card-body py-2">
                                            <div className="d-flex align-items-center">
                                                <img src="https://polkadot.network/assets/img/logos/logo-circle-newsletter.svg?v=ea608e625d" width={50} alt='' />
                                                <div className='mx-2'>
                                                    <h5 className="mb-1">Mailing list</h5>
                                                    <p className="mb-0">Don’t miss updates.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div className="col-md-6 col-xl-4 mt-0 mb-4">
                                <a href="/" target="_blank" className='text-decoration-none text-black'>
                                    <div className="card shadow-lg bg-white rounded-lg">
                                        <div className="card-body py-2">
                                            <div className="d-flex align-items-center">
                                                <img src="https://polkadot.network/assets/img/logos/logo-circle-reddit.svg?v=ea608e625d" width={50} alt='' />
                                                <div className='mx-2'>
                                                    <h5 className="mb-1">Reddit</h5>
                                                    <p className="mb-0">Discuss Polkadot news.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div className="card-body py-2">
                                            <div className="d-flex align-items-center">
                                                ...
                                                <div className='mx-2'>
                                                    ...
                                                    <p className="mb-0">Contribute to the codebase.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div className="col-md-6 col-xl-4 mt-0 mb-4">
                                <a href="/" target="_blank" className='text-decoration-none text-black'>
                                    <div className="card shadow-lg bg-white rounded-lg">
                                        <div className="card-body py-2">
                                            <div className="d-flex align-items-center">
                                                <img src="https://polkadot.network/assets/img/logos/logo-circle-discord.svg?v=ea608e625d" width={50} alt='' />
                                                <div className='mx-2'>
                                                    <h5 className="mb-1">Discord</h5>
                                                    <p className="mb-0">Discuss with the community.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
